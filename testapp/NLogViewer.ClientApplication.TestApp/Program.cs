...
namespace NLogViewer.ClientApplication.TestApp
{
    class Program
    {
        ...
        private static string GetRandomLoggerName()
        {
            var loggerNames = new[]
            {
                "NLogViewer.ClientApplication.TestApp",
                "NLogViewer.ClientApplication.TestApp.Services",
                "NLogViewer.ClientApplication.TestApp.Services.DataService",
                "NLogViewer.ClientApplication.TestApp.Services.NetworkService",
                "NLogViewer.ClientApplication.TestApp.Controllers",
                "NLogViewer.ClientApplication.TestApp.Controllers.HomeController",
                "NLogViewer.ClientApplication.TestApp.Models",
                "NLogViewer.ClientApplication.TestApp.Utils"
            };
